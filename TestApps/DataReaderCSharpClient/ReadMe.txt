========================================================================
    CONSOLE APPLICATION : DataExtractorCSharpClient Project Overview
========================================================================

This is an example of a C# project that accesses the MassHunter Data 
Access Component (MHDAC) libraries via .NET interfaces.   When run, it
...
paths in DataReaderCSharpClient.cs file.
